...
* if for some reason GitHub is going down during the migration of the issues, the script detects already migrated issues, establishes a consistent state and continues with the migration
